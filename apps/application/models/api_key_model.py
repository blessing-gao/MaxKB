...
class ApplicationApiKey(AppModelMixin):
    ...
    application = models.ForeignKey(Application, on_delete=models.CASCADE, verbose_name="智能体id")
...
class ApplicationAccessToken(AppModelMixin):
    ...
    智能体认证token
    """
    application = models.OneToOneField(Application, primary_key=True, on_delete=models.CASCADE, verbose_name="智能体id")
